...
// MUI
import { Grid, Typography, Button, CircularProgress, IconButton, Breadcrumbs, Link, Dialog, Snackbar } from '@mui/material'
...
function ListingDetail() {
    ...
    const stadiumIcon = new Icon({ iconUrl: stadiumIconPng, iconSize: [40, 40], })
    const hospitalIcon = new Icon({ iconUrl: hospitalIconPng, iconSize: [40, 40], })
    const universityIcon = new Icon({ iconUrl: universityIconPng, iconSize: [40, 40], })
